...
//Continue for mass calculating {"04/08/25-Cash":4550}    
    "01922362569":{
        ...
        post_payable        :3060,
        previous_paid       :3850,
        previous_dining_cost:1625,
        payment             :{"01/04/26-DBBL":500,"07/04/26-Cash":2000,"12/04/26-DBBL":1000,"15/04/26-Cash":300,"19/04/26-bKash":400,"27/04/26-DBBL":500},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :3495,//3495
        running_paid    :4700,
        running_meal    :26,
        // method 
        preMonth,
    ...
    "01797816501":{
        ...
        previous_paid       :4000,
        previous_dining_cost:1625,
        payment             :{"01/04/26-Cash":4000,"09/04/26-Cash":1000,"21/04/26-Cash":1000},
        // running month{"04/08/25-Cash":4550}
        stay_cost       :2300,
        garage_cost     :0,
        running_payable :3502,//3502
        running_paid    :6000,
        running_meal    :36,
        // method calling
        preMonth,
    ...
    "01880384113":{
        ...
        payment             :{"01/04/26-Cash":2700,"11/04/26-Cash":3500,"13/04/26-Cash":2000},
        // running month
        stay_cost       :3250,
        garage_cost     :0,
        running_payable :5460,//5460
        running_paid    :8200,
        running_meal    :37,
        // method calling
        preMonth,
    ...
    "01581515641":{//01644377150
        ...
        post_payable        :6420,
        previous_paid       :3000,
        previous_dining_cost:1690,
        payment             :{"04/04/26-Cash":4000,"17/04/26-Cash":2000},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :8570,//5320
        running_paid    :6000,
        running_meal    :53,
        // method calling
        preMonth,
    ...
    "01537664564":{
        ...
        payment             :{"01/04/26-Cash":1000,"09/04/26-Cash":5000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :3809,//3809
        running_paid    :6000,
        running_meal    :52,
        // method calling
        preMonth,
    ...
    "01716726510":{
        ...
        payment             :{"10/04/26-Bkash":1000,"20/04/26-Cash":4000,"23/04/26-bKash":1000},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
    ...
    "01934147404":{
        ...
        previous_paid       :5000,
        previous_dining_cost:1625,
        payment             :{"01/04/26-Cash":1000,"05/04/26-Cash":3000,"09/04/26-Cash":2000,"15/04/26-Cash":500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4359,//4359
        running_paid    :6500,
        running_meal    :30,
        // method calling
        preMonth,
	...
	"01639523533":{
        ...
        previous_paid       :3500,
        previous_dining_cost:1625,
        payment             :{"01/04/26-Cash":3000,"07/04/26-Cash":3500,"09/04/26-Cash":2000},
        // running month {"01/07/24-Cash":500}
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :6232,//6232
        running_paid    :8500,
        running_meal    :28,
        // method calling
        preMonth,
    ...
    "01521706612":{
        ...
        previous_paid       :3680,
        previous_dining_cost:1625,
        payment             :{"02/04/26-Cash":2500,"09/04/26-Cash":1500,"27/04/26-Cash":600,"29/04/26-Cash":500},
        // running month
        stay_cost       :0,
        garage_cost     :0,
        running_payable :2547,//2547
        running_paid    :5100,
        running_meal    :40,
        // method calling
        preMonth,
	...
	"01821245430":{
        ...
        previous_paid       :0,
        previous_dining_cost:0,
        payment             :{"08/04/26-Cash":1000,"09/04/26-Cash":1000,"15/04/26-Cash":1000},
        // running month
        stay_cost       :0,
        garage_cost     :0,
        running_payable :0,
